      ...
      {featured && (
        <section style={{ padding: '3rem 0 0', background: 'var(--clr-bg)' }}>
          <div className="container">
            <Link href={`/blog/${featured.slug.current}`} className="card-hover-glow" style={{ display: 'grid', gridTemplateColumns: '460px 1fr', border: '1px solid var(--clr-border)', borderRadius: 'var(--radius-xl)', overflow: 'hidden', background: 'var(--clr-surface)', textDecoration: 'none', minHeight: '460px' }}>
              <div style={{ position: 'relative', width: '460px', height: '460px', flexShrink: 0, overflow: 'hidden' }}>
