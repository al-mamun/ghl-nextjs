    ...
    <>
      ...
      {featured && (
        <section style={{ padding: '4rem 0 0', background: 'var(--clr-bg)' }}>
          <div className="container">
            <Link href={`/case-studies/${featured.slug.current}`} className="card-hover-glow cs-featured-card" style={{ display: 'grid', border: '1px solid var(--clr-border)', borderRadius: 'var(--radius-xl)', overflow: 'hidden', background: 'var(--clr-surface)', textDecoration: 'none', marginBottom: '2rem' }}>
              {/* Thumbnail */}
      ...
      {rest.length > 0 && (
        <section style={{ padding: '2rem 0 5rem', background: 'var(--clr-bg)' }}>
          <div className="container">
            <div className="cs-cards-grid" style={{ display: 'grid', gap: '1.5rem' }}>
              {rest.map((cs) => (
